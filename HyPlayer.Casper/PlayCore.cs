...
namespace HyPlayer.Casper
{
    public sealed class PlayCore : DependencyObject
    {
        ...
        {
            get { return (SongContainer)GetValue(PlayListSourceProperty); }
        ...
        {
            get { return (int)GetValue(NowPlayIndexProperty); }
        ...
        {
            get { return (PlayRollMode)GetValue(PlayRollingModeProperty); }
        ...
        {
            get { return (bool)GetValue(PlayListChangedIndicatorProperty); }
        ...
        {
            get { return (SingleSong)GetValue(NowPlayingSongProperty); }
        ...
        /// </summary>
        /// <param name="item">音乐单曲</param>
        public void InsertPlayItemToNext(SingleSong item) => InsertPlayItem(item, Math.Max(NowPlayIndex, 0)); // 0 是防止越界
